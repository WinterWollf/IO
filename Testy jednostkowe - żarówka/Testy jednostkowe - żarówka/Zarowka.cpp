...
int Zarowka::get_godzina_zapalenia() {
    return godzina_zapalenia;
}

int Zarowka::get_minuta_zapalenia() {
    return minuta_zapalenia;
}

int Zarowka::get_godzina_zgaszenia() {
    return godzina_zgaszenia;
}

int Zarowka::get_minuta_zgaszenia() {
    return minuta_zgaszenia;
}

int Zarowka::get_natezenie() {
    return natezenie;
}

int Zarowka::get_temperatura_barwy() {
