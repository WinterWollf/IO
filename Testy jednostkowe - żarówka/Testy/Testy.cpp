...
#include "../Testy jednostkowe - żarówka/Zarowka.cpp"
#include "../Testy jednostkowe - żarówka/Dane.cpp"
#include "../Testy jednostkowe - żarówka/Wyjatki.h"
...
namespace Testy
{
	...
	public:
		...
		TEST_METHOD(Czas_Zapalenia)
		{
			...
			Assert::AreEqual(14, h_zap, BlednaGodzinaZapalenia);
		...
		{
			const wchar_t* BledneNatezenie = L"Bledna intensywnosc swiecenia";
